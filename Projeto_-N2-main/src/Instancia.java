...
public class Instancia {
        public Instancia() {
                ...
                Proprietario proprietario1 = new Proprietario("Carlos", "11122233344", "carlos@email.com", "Rua C, 789",
                                "senha789");
                Usuario.cadastrarNovoUsuario(proprietario1);

                Proprietario proprietario2 = new Proprietario("Ana", "44455566677", "ana@email.com", "Rua D, 1011",
                                "senha1011");
                Usuario.cadastrarNovoUsuario(proprietario2);

                Propriedade propriedade1 = new Propriedade("Casa na Praia", "Casa aconchegante à beira-mar",
                                "Praia Grande", 5,
                                200.0);
                MackAirbnb.getInstancia().cadastrarPropriedade(propriedade1, proprietario);

                Propriedade propriedade2 = new Propriedade("Chácara das Flores", "Chácara com piscina e jardim",
                                "Interior", 10,
                                300.0);
                MackAirbnb.getInstancia().cadastrarPropriedade(propriedade2, proprietario2);

                Propriedade propriedade3 = new Propriedade("Apartamento Central",
                                "Ótima localização no centro da cidade",
                                "Centro",
                                3, 150.0);
                MackAirbnb.getInstancia().cadastrarPropriedade(propriedade3, proprietario1);

                Propriedade propriedade4 = new Propriedade("Casa na Montanha", "Vista panorâmica da montanha", "Serra",
                                8,
                                250.0);
                MackAirbnb.getInstancia().cadastrarPropriedade(propriedade4, proprietario2);

                Propriedade propriedade5 = new Propriedade("Chalé na Praia",
                                "Chalé aconchegante a poucos metros da praia",
                                "Praia",
                                4, 180.0);
                ...
                Reserva reserva6 = new Reserva(propriedade2, hospede);
                reserva6.setDataCheckIn(LocalDate.of(2023, 12, 10));
                reserva6.setDataCheckOut(LocalDate.of(2023, 12, 15));

                Reserva reserva7 = new Reserva(propriedade2, hospede);
                reserva7.setDataCheckIn(LocalDate.of(2023, 12, 13));
                reserva7.setDataCheckOut(LocalDate.of(2023, 12, 18));
                ...
                MackAirbnb.reservas.add(reserva6);
                MackAirbnb.reservas.add(reserva7);
