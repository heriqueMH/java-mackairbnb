...
public class Instancias {
    public Instancias() {
        ...
        Propriedade propriedade1 = new Propriedade("Casa na Praia", "Casa aconchegante à beira-mar", "Praia Grande", 5,
                200.0);
        MackAirbnb.getInstancia().cadastrarPropriedade(propriedade1, proprietario);

        Propriedade propriedade2 = new Propriedade("Chácara das Flores", "Chácara com piscina e jardim", "Interior", 10,
                300.0);
        MackAirbnb.getInstancia().cadastrarPropriedade(propriedade2, proprietario2);

        Propriedade propriedade3 = new Propriedade("Apartamento Central", "Ótima localização no centro da cidade",
                "Centro",
                3, 150.0);
        MackAirbnb.getInstancia().cadastrarPropriedade(propriedade3, proprietario1);

        Propriedade propriedade4 = new Propriedade("Casa na Montanha", "Vista panorâmica da montanha", "Serra", 8,
                250.0);
        MackAirbnb.getInstancia().cadastrarPropriedade(propriedade4, proprietario2);

        Propriedade propriedade5 = new Propriedade("Chalé na Praia", "Chalé aconchegante a poucos metros da praia",
                "Praia",
                4, 180.0);
