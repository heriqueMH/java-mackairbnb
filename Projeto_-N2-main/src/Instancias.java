...
public class Instancias {
  public Instancias() {
    ...
    Propriedade propriedade3 = new Propriedade("Apartamento Central", "Ótima localização no centro da cidade", "Centro",
        3, 150.0);
    ...
    Propriedade propriedade5 = new Propriedade("Chalé na Praia", "Chalé aconchegante a poucos metros da praia", "Praia",
        4, 180.0);
